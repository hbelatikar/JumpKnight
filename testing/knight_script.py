...
if platform == "linux" or platform == "linux2":
    ...
    os.system("vsim -c -coverage -do \"run -all; coverage save -assert -directive -cvg -codeAll \\coverage\\ucdb\\KnightsTour_tb_PWM_NEMO_check.ucdb; exit\" KnightsTour_tb_PWM_NEMO_check")
    os.system("vsim -c -coverage -do \"run -all; coverage save -assert -directive -cvg -codeAll \\coverage\\ucdb\\KnightsTour_tb_cal_check.ucdb; exit\"      KnightsTour_tb_cal_check")
    os.system("vsim -c -coverage -do \"run -all; coverage save -assert -directive -cvg -codeAll \\coverage\\ucdb\\KnightsTour_tb_moveW1.ucdb; exit\"         KnightsTour_tb_moveW1")
    os.system("vsim -c -coverage -do \"run -all; coverage save -assert -directive -cvg -codeAll \\coverage\\ucdb\\KnightsTour_tb_moveE2FF.ucdb; exit\"       KnightsTour_tb_moveE2FF")
    os.system("vsim -c -coverage -do \"run -all; coverage save -assert -directive -cvg -codeAll \\coverage\\ucdb\\KnightsTour_tb_tour_chk.ucdb; exit\"       KnightsTour_tb_tour_chk")
    os.system("vsim -c -coverage -do \"run -all; coverage save -assert -directive -cvg -codeAll \\coverage\\ucdb\\KnightsTour_tb_tour_move.ucdb; exit\"      KnightsTour_tb_tour_move")
